...
class openSRS_ops {
	...
	function XML2PHP($msg) {
		...
		/* Changed bt BC : NG : on 6-3-2015 : To resolved issue of integration Code Not Generating Line Breaks  */
        /*xml_parser_set_option($xp, XML_OPTION_SKIP_WHITE, true);*/
        xml_parser_set_option($xp, XML_OPTION_SKIP_WHITE, false);
        /* End : To resolved issue of integration Code Not Generating Line Breaks  */  
